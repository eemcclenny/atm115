...
filepath = '/home/eelliott/Documents/ATM115/'
data3d = '/home/eelliott/Documents/ATM115/sam3d.nc'
data2d = '/home/eelliott/Documents/ATM115/sam2d.nc'
outputfilename = '300K_vars_troposphere.nc'
...
myzrange = z<10000 # only get tropospheric values
z = z[myzrange]
qv = qv[:,myzrange,:]
temp = temp[:,myzrange,:]
pressure_ref = pressure_ref[myzrange]
pres_pert = pres_pert[:,myzrange,:]


# In[33]:


pressure = np.zeros((3600,38,1024))
# Pressure perturbarion + base state
for i in range(0,1024):
    for j in range(0,3600):
        pressure[j,:,i] = (pres_pert[j,:,i])/100 + pressure_ref[:]
